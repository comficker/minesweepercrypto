<template>
  <div class="fixed bottom-0 left-0 right-0 md:relative p-4 py-2 md:p-0 z-10 bg-white md:bg-transparent border-t md:border-t-0">
    <div
      class="flex grid-cols-3 gap-4 text-xs font-bold justify-between md:grid"
    >
